...
const oe = "/graphics/logo.png",
  $e = {},
  Se = t("img", { class: "w-16 relative top-3", src: oe, alt: "" }, null, -1);
function Le(e, o) {
  const n = c("router-link");
  return l(), C(n, { to: "/#hero" }, { default: x(() => [Se]), _: 1 });
}
const Me = f($e, [["render", Le]]),
  Be = {},
  Ne = {
...
const Ee = {
  ...
  Ue = ["disabled"],
  De = ["src"],
  je = { class: "relative top-0.5" },
  Ae = { key: 0, class: "text-base relative -top-1 opacity-65" },
  He = ["src"],
  ze = { class: "relative top-0.5" },
  Oe = { key: 0, class: "text-base relative -top-1 opacity-65" };
      ...
      C(
        ...
        },
        {
          default: x(() => [
            ...
            t("span", ze, [
              y(s(n.text) + " ", 1),
              n.amount ? (l(), r("span", Oe, s(n.amount), 1)) : S("", !0),
            ]),
          ]),
          _: 1,
        },
    ...
    : (l(),
      r(
        "button",
        {
          key: 0,
          class: $([
            "main-button rounded-lg button-effect relative w-full",
            {
              "btn-large": n.size == "large",
              "btn-small": n.size == "small",
              "btn-success": n.type == "success",
        ...
        [
            ...
            ? (l(),
              r(
                "img",
                {
                  key: 0,
                  class: $({
                    "absolute -left-9 w-16 top-1 bottom-0 my-auto":
                      n.icon == "connect",
                  }),
          ...
          t("span", je, [
            y(s(n.text) + " ", 1),
            n.amount ? (l(), r("span", Ae, s(n.amount), 1)) : S("", !0),
          ]),
        ],
        10,
        Ue
...
const N = f(Ee, [["render", Pe]]),
  ...
  We = {
    ...
    components: { Logo: Me, MobileButton: Ie, Button: N },
    computed: {
      ...v([
        "isConnected",
        "buyOnDexUrl",
      ...
      headerLinks() {
        return [
          ...
          { name: "Game Theory", url: "/#mechanics" },
          { name: "Mullet Board", url: "/#dashboard" },
  ...
  qe = { class: "lg:flex hidden flex-col fixed top-24 gap-2" },
  Ge = ["href"],
  Ze = t("img", { src: se, alt: "" }, null, -1),
  Je = [Ze],
  Ke = ["href"],
  Qe = t("img", { src: le, alt: "" }, null, -1),
  Xe = [Qe],
  et = ["href"],
  tt = t("img", { src: ae, alt: "" }, null, -1),
  nt = [tt],
  ot = ["href"],
  st = t("img", { src: ie, alt: "" }, null, -1),
  lt = [st],
  at = { class: "flex w-full lg:flex-row flex-col gap-5" },
  it = ["href"],
  rt = _e(
    '<div class="lg:hidden flex items-center justify-between my-6 gap-2"><a href="" class="w-10"><img src="' +
      se +
      '" alt=""></a><a href="" class="w-10"><img src="' +
      le +
      '" alt=""></a><a href="" class="w-10"><img src="' +
      ae +
      '" alt=""></a><a href="" class="w-10"><img src="' +
...
function dt(e, o, n, g, u, a) {
  ...
  return (
    ...
    r(
      ...
      {
        class: $([
          u.open ? "open bg-nav lg:bg-transparent" : "close",
          "flex lg:flex-row flex-col items-center justify-between fixed z-4 top-0 left-0 w-full",
        ]),
      },
      [
        t("div", Ye, [
        ...
        t(
          ...
          {
            class: $([
              u.open ? "block sm:pt-10 pt-0 mt-5" : "hidden",
              "w-full h-full px-10 rounded-bl-3xl rounded-br-3xl lg:flex lg:items-center lg:w-auto gap-6 lg:pb-2 bg-nav",
            ]),
          },
          [
            t("div", at, [
                          ...
                          ? (l(),
                            r(
                              "a",
                              {
                                ...
                                rel: "noopener noreferrer",
                                class:
                                  "no-underline block lg:inline-block lg:mt-0 text-teal-lighter hover:text-white button-nav canaro-semibold",
                              },
                              s(h.name),
                              9,
                              it
...
const ut = f(We, [["render", dt]]),
  mt = "/graphics/hero-circle.png",
  ht = "/graphics/hero-triangle.png",
  ft = {},
  _t = t(
    "img",
    { src: mt, class: "absolute top-0 bottom-0 left-0 my-auto", alt: "" },
    null,
    -1
  ),
  gt = t(
    "img",
    { src: ht, class: "absolute top-0 bottom-0 right-0 my-auto", alt: "" },
    null,
    -1
  ),
  pt = [_t, gt];
...
const P = f(ft, [["render", bt]]),
  wt = "/graphics/copy.png",
  yt = { computed: { ...v(["tokenAddress"]) }, methods: { onCopy: ge } },
  kt = {
    class:
      "flex items-center justify-center gap-2 bg-white text-center box-effect py-2 canaro-bold px-6",
  },
  vt = { class: "relative top-0.5 sm:w-max w-48 whitespace-nowrap truncate" },
  Ct = t("img", { class: "h-5", src: wt, alt: "" }, null, -1),
  xt = [Ct];
function $t(e, o, n, g, u, a) {
  return (
    l(),
    r("div", kt, [
      t("span", vt, s(e.tokenAddress), 1),
      t(
        "button",
...
const re = f(yt, [["render", $t]]),
  ...
  Bt = {
    id: "hero",
    class:
      "lg:h-screen min-h-hero w-full flex flex-col justify-start lg:justify-center items-center mx-auto px-4 relative pt-10",
  },
  Nt = t(
    "div",
    {
      class:
        "flex lg:flex-row flex-col items-center w-full max-w-7xl -space-y-24 gap-10 relative z-2",
    },
    [
      t("img", { src: ce, alt: "", class: "w-2/3 lg:w-1/2 object-contain" }),
      t("img", {
        src: St,
        alt: "",
  ...
  Tt = {
    class:
      "flex lg:flex-row flex-col gap-5 max-w-7xl justify-start w-full relative z-1 mt-28 lg:mt-0",
  },
  Ft = { class: "flex flex-col gap-4" },
  Rt = t(
    "div",
    { class: "flex items-center w-92 bg-yellow box-effect px-8 gap-5 py-2" },
    [
      t("img", { src: oe, class: "object-contain w-32 -ml-12", alt: "" }),
      t("div", { class: "lg:text-2xl flex flex-col gap-2 leading-none" }, [
        t("img", { src: Lt, class: "w-80", alt: "" }),
        y(" More than a hairstyle, it's an identity "),
      ]),
    ],
    -1
  ),
  Vt = {
    class:
      "flex flex-col items-center justify-center w-92 bg-darkBlue box-effect pt-4 pb-6 px-8 gap-0",
  },
  It = {
    class:
      "canaro-black text-white text-effect text-5xl lg:text-6xl z-2 relative stroke-effect leading-none",
  },
  Et = t(
    "h3",
    { class: "canaro-bold text-white leading-none text-2xl lg:text-3xl" },
    [y(" GAME THEORY "), t("span", { class: "text-yellow" }, "REWARDS")],
    -1
  ),
  Ut = ["href"];
function Dt(e, o, n, g, u, a) {
      ...
      t("div", Tt, [
        ...
        t("div", Vt, [
          t(
            "h2",
            It,
            s(e.totalRewardsFormatted) + " " + s(e.nativeCurrencySymbol),
            1
          ),
          Et,
          t(
...
const jt = f(Mt, [["render", Dt]]),
  At = { props: { title: String, subtitle: String } },
  Ht = { class: "max-w-section py-16 relative z-2" },
  zt = { class: "mb-5 text-center" },
  Ot = {
    class:
      "krungthep-title canaro-title w-full text-center uppercase flex justify-center mb-5 relative z-1 whitespace-pre leading-none text-wrap",
  },
  Pt = { class: "text-white text-center flex items-center justify-center" };
function Wt(e, o, n, g, u, a) {
  return (
    ...
    r("section", Ht, [
      t("div", zt, [
        t("h2", Ot, s(n.title), 1),
        t("span", Pt, [O(e.$slots, "subtitle")]),
      ]),
      O(e.$slots, "default"),
    ])
  );
}
const I = f(At, [["render", Wt]]),
  Yt = {
    props: {
      name: { type: String },
  ...
  Gt = ["src"],
  Zt = ["src"],
  Jt = { class: "text-sm tracking-tighter" },
  Kt = { class: "text-4xl leading-none" };
  ...
  return (
    ...
    r(
      ...
      [
        ...
        t(
          "div",
          { class: $({ "text-white": n.white }) },
          [t("span", Jt, s(n.name), 1), t("h3", Kt, s(n.amount), 1)],
          2
        ),
      ],
      2
...
const de = f(Yt, [["render", Qt]]),
  ...
  tn = { class: "flex items-center h-auto gap-3" },
  nn = t("img", { src: Xt, class: "h-7", alt: "" }, null, -1),
  on = { class: "text-sm canaro-bold text-black relative top-0.5" };
function sn(e, o, n, g, u, a) {
  return (
    l(),
    r("div", tn, [
      nn,
      t("h1", on, " Welcome, " + s(a.getShortAddress(e.userAddress)), 1),
    ])
  );
}
const ue = f(en, [["render", sn]]);
/*! vue-countdown v2.1.2 | (c) 2018-present Chen Fengyuan | MIT */ const A = 1e3,
  H = 60 * A,
  z = 60 * H,
  J = 24 * z,
  K = "abort",
...
var ln = be({
  ...
  methods: {
    ...
    abort() {
      !this.counting ||
        (this.pause(), (this.counting = !1), this.emitEvents && this.$emit(K));
    },
    end() {
      !this.counting ||
        (this.pause(),
...
const Ln = f(kn, [["render", Sn]]),
  Mn = {
    ...
    computed: {
      ...D({
        minLockupTimeSeconds: ({ main: e }) =>
          (e.gameTheoryRewardsData &&
            e.gameTheoryRewardsData.MIN_LOCKUP_TIME) ||
          0,
      }),
      ...v([
        "nativeCurrencySymbol",
        "tokenSymbol",
        "userLastClaimAmtFormatted",
        "userLastClaimUnix",
        "userUnclaimedRewardsFixed",
        "userUnclaimedRewardsFormatted",
      ]),
      unlockedIn() {
        const o = this.$dayjs
          .unix(this.userLastClaimUnix)
          .add(this.minLockupTimeSeconds, "seconds");
    ...
    methods: {
      ...
      async payback() {
        try {
          if (
            new V(this.userUnclaimedRewardsFixed).gt(0) &&
            !(
  ...
  Bn = {
    class:
      "flex flex-col items-start w-full p-5 bg-pink rounded-lg border-4 border-black mt-5 gap-5",
  },
  Nn = {
    class:
      "flex sm:flex-row flex-col sm:gap-0 gap-5 items-center justify-between w-full",
  },
  Tn = { class: "flex items-center gap-3.5" },
  Fn = { class: "text-black canaro-bold text-2xl relative top-1.5" },
  Rn = { class: "flex items-center gap-3.5" };
      ...
      t("div", Nn, [
        t("div", Tn, [
          ...
          t(
            "span",
            Fn,
            " Your Wallet's " + s(e.tokenSymbol) + " are Locked ",
            1
          ),
        ]),
        t("div", Rn, [
          ...
          i(
            _,
            { time: a.unlockedIn, class: "text-2xl relative top-1" },
            {
              default: x(({ days: h, hours: b, minutes: p, seconds: T }) => [
                y(
                  " Minimum Lockup Countdown: " +
                    s(h) +
                    "d " +
                    s(b) +
                    "h " +
...
const In = f(Mn, [["render", Vn]]),
  ...
  Dn = {
    ...
    computed: {
      ...
      ...v([
        ...
        "nativeCurrencySymbol",
        "tokenSymbol",
        "tokenMarketCapUSDFormatted",
        "tokensLockedFormatted",
        "totalRewardsUSDFormatted",
        "canClaimRewardsFromFirstClaimDelay",
        "firstClaimTimeLocal",
        "userLastClaimAmtFormatted",
        "userLastClaimAmtUSDFormatted",
        "userTotalRewardsFormatted",
        "userTotalRewardsUSDFormatted",
        "userUnclaimedRewardsFixed",
        "userUnclaimedRewardsFormatted",
        "userUnclaimedRewardsUSDFormatted",
        "userTokenBalanceFormatted",
        "totalHolders",
        "tweetBtnText",
      ]),
      claimRewBtnText() {
        return this.canClaimRewardsFromFirstClaimDelay
          ? `Claim ${this.nativeCurrencySymbol} Rewards`
          : `First claim at ${this.firstClaimTimeLocal}`;
      },
      hasUnclaimedRewards() {
        return (
          this.userUnclaimedRewardsFixed &&
          new V(this.userUnclaimedRewardsFixed).gt(0)
        );
      },
    },
    methods: {
      ...U(["init", "disconnect", "claimRewards"]),
      ...
      async claimGameTheoryRewards(e) {
        try {
          if (
            ...
            return;
          await this.claimRewards(e),
            this.$notify({
              type: "success",
              text: "Successfully claimed your rewards!",
            });
        } catch (o) {
          this.$notify({ type: "error", text: o.message });
        }
      },
    },
  },
  jn = { id: "dashboard", class: "dots bg-lightYellow relative" },
  An = { class: "flex flex-col lg:flex-row gap-5 w-full" },
  Hn = { class: "mt-10" },
  zn = {
    class:
      "flex flex-col lg:flex-row justify-between items-center bg-yellow px-5 py-3 border-4 border-black text-xl",
  },
  On = { class: "canaro-black" },
  Pn = {
    class:
      "bg-white border-4 border-t-0 border-black py-9 lg:py-16 px-8 lg:px-10",
  },
  Wn = ["href"],
  Yn = t("img", { class: "h-7", src: En }, null, -1),
  qn = [Yn],
  Gn = { class: "grid grid-cols-1 lg:grid-cols-3 gap-7 mt-2 mb-7" },
  Zn = {
    class:
      "border-blue bg-green bg-opacity-20 border-2 p-4 flex flex-col box-effect-gray text-2xl",
  },
  Jn = t("span", null, "Your Unclaimed Rewards", -1),
  Kn = { class: "canaro-semibold text-5xl leading-none" },
  Qn = {
    class: "border-orange border-2 p-4 flex flex-col box-effect-gray text-2xl",
  },
  Xn = t("span", null, "Your Last Claim", -1),
  eo = { class: "canaro-semibold text-5xl leading-none" },
  to = {
    class: "border-blue border-2 p-4 flex flex-col box-effect-gray text-2xl",
  },
  no = t("span", null, "Your Aggregate Rewards", -1),
  oo = { class: "canaro-semibold text-5xl leading-none" },
  so = { class: "flex border-t mt-10 pt-6 text-gray-500" },
  lo = t("br", null, null, -1),
  ao = t("br", null, null, -1),
  io = t("br", null, null, -1),
  ro = t("br", null, null, -1),
  co = t(
    ...
    null,
    [
      t("div", { class: "mt-4 p-4 border rounded-2xl lg:w-2/3 m-auto" }, [
        t("img", { class: "object-contain", src: Un }),
      ]),
    ],
    -1
  );
        ...
        { title: "mullet board" },
        {
          default: x(() => [
            ...
            t("div", Hn, [
              t("div", zn, [
                t("div", null, [
                  y(" Your wallet balance: "),
                  t(
                    "span",
                    On,
                    s(e.isConnected ? e.userTokenBalanceFormatted : "...") +
                      " " +
                      s(e.tokenSymbol),
                    1
                  ),
              ...
              t("div", Pn, [
                        ...
                        t("div", Gn, [
                          t("div", Zn, [
                            ...
                            t(
                              "b",
                              Kn,
                              s(e.userUnclaimedRewardsFormatted) +
                                " " +
                                s(e.nativeCurrencySymbol),
                              1
                            ),
                            t(
                              "small",
                              null,
                              " \u2248 $" +
                                s(e.userUnclaimedRewardsUSDFormatted),
                              1
                            ),
                          ]),
                          t("div", Qn, [
                            ...
                            t(
                              "small",
                              null,
                              "\u2248 $" + s(e.userLastClaimAmtUSDFormatted),
                              1
                            ),
                          ]),
                          t("div", to, [
                            ...
                            t(
                              "small",
                              null,
                              "\u2248 $" + s(e.userTotalRewardsUSDFormatted),
                              1
                            ),
                          ]),
                        ]),
                          ...
                          ? (l(),
                            C(
                              _,
                              {
                                ...
                                onClick:
                                  o[0] ||
                                  (o[0] = (b) => a.claimGameTheoryRewards(!1)),
                                disabled:
                                  !a.hasUnclaimedRewards ||
                                  !e.canClaimRewardsFromFirstClaimDelay,
                          ...
                          ? (l(),
                            C(
                              _,
                              {
                                ...
                                onClick:
                                  o[1] ||
                                  (o[1] = (b) => a.claimGameTheoryRewards(!0)),
                ...
                t("span", so, [
                  y(
                    " Game theory " +
                      s(e.nativeCurrencySymbol) +
                      " rewards are continuously accumulated through " +
                      s(e.tokenSymbol) +
                      " trading. As long as you're holding " +
                      s(e.tokenSymbol) +
                      ", you're accumulating " +
                      s(e.nativeCurrencySymbol) +
                      ". If you transfer " +
                      s(e.tokenSymbol) +
                      " to another wallet or sell, any unclaimed rewards are distributed to all other " +
                      s(e.tokenSymbol) +
                      " holders. If you decide to claim your unclaimed rewards, " +
                      s(e.nativeCurrencySymbol) +
                      " is instantly delivered to your wallet, however at that time all of your " +
                      s(e.tokenSymbol) +
                      " becomes locked for a minimum duration of 3 days. Your " +
                      s(e.tokenSymbol) +
                      " will be unlocked once 3 days have passed and your newly accumulated unclaimed " +
                      s(e.nativeCurrencySymbol) +
                      " rewards reach or exceed the last " +
                      s(e.nativeCurrencySymbol) +
                      " rewards you claimed. ",
                    1
                  ),
                  ...
                  y(
                    " If at any time your " +
                      s(e.tokenSymbol) +
                      " are locked from claiming rewards and you'd like to unlock them, you can pay back the most recent amount of " +
                      s(e.nativeCurrencySymbol) +
                      " you claimed. This paid back " +
                      s(e.nativeCurrencySymbol) +
                      " and all newly accumulated unclaimed rewards are forfeited to all other " +
                      s(e.tokenSymbol) +
                      " holders. ",
                    1
                  ),
                  ...
                  ro,
                  y(
                    " You may also claim & compound " +
                      s(e.nativeCurrencySymbol) +
                      " rewards anytime including while you're locked. This converts all unclaimed " +
                      s(e.nativeCurrencySymbol) +
                      " to " +
                      s(e.tokenSymbol) +
                      " by market buying and adding it to your wallet. Again this can be done anytime you have unclaimed " +
                      s(e.nativeCurrencySymbol) +
                      " available even while your " +
                      s(e.tokenSymbol) +
                      " is locked, however it will add to the amount of " +
                      s(e.nativeCurrencySymbol) +
                      " rewards needed to unlock your wallet. ",
                    1
                  ),
                ]),
                co,
...
(function (e, o) {
  (function (n, g) {
    ...
    var n = "__v-click-outside",
      ...
      a =
        g && ("ontouchstart" in window || (u && navigator.msMaxTouchPoints > 0))
          ? ["touchstart"]
          : ["click"],
      d = function (h) {
        var b = h.event,
              ...
              return {
                ...
                handler: function (L) {
                  return (function (M) {
                    ...
                    (Z ? Z.indexOf(R) < 0 : !R.contains(F.target)) &&
                      d({ event: F, handler: Y, middleware: E });
                  })({ el: h, event: L, handler: T, middleware: j });
                },
                capture: W,
              };
            })),
                ...
                return (function (L) {
                  ...
                  setTimeout(function () {
                    ...
                    E &&
                      E.tagName === "IFRAME" &&
                      !M.contains(E) &&
                      d({ event: R, handler: F, middleware: Y });
                  }, 0);
                })({ el: h, event: k, handler: T, middleware: j });
              },
              capture: W,
            };
            h[n] = [].concat(h[n], [fe]);
...
const wo = me.exports,
  yo = {
    name: "Modal",
    components: {},
    directives: { clickOutside: wo.directive },
    props: {
      title: { type: String },
      subText: { type: String },
      large: { type: Boolean },
  ...
  Co = { class: "fixed inset-0 z-10 overflow-y-auto" },
  xo = {
    class:
      "w-full flex h-screen items-start justify-center p-2 md:p-4 text-center sm:items-start sm:p-0",
  },
  $o = t(
    "svg",
    {
  ...
  Lo = {
    class:
      "relative flex items-center justify-start md:justify-center w-full gap-3",
  },
  Mo = { class: "flex flex-col pb-3" },
  Bo = { key: 0, class: "mt-3 text-md md:text-center sm:mt-2 text-gray-600" },
  No = { class: "mt-4" };
          ...
          t("div", xo, [
            Ce(
              ...
              r(
                ...
                {
                  class: $([
                    "relative text-left transition-all transform w-full my-auto overflow-hidden",
                    {
                      "sm:max-w-md": !n.large,
                ...
                [
                      ...
                      ? (l(),
                        r(
                          "h1",
                          {
                            key: 0,
                            class: $([
                              "text-black canaro-black text-3xl",
                              { "pt-7": n.noPadding },
                            ]),
                          },
                          s(n.title),
                  ...
                  t("div", Mo, [
                    n.subText ? (l(), r("h3", Bo, s(n.subText), 1)) : S("", !0),
                    t("div", No, [O(e.$slots, "default")]),
                  ]),
                ],
                2
              )),
...
const Fo = f(yo, [["render", To]]),
  Ro = {
    name: "NetworkSelect",
    components: { IconArrow: bo, Modal: Fo },
    props: {
      modelValue: { type: [String, Object] },
      options: { type: Array, required: !0 },
      isChangeNetwork: { type: Boolean, default: !1 },
    },
    computed: {
      ...v(["isConnected"]),
      selectedNetwork: {
        ...
        async set(e) {
          ...
          this.isChangeNetwork
            ? await this.switchNetwork(o)
            : this.$emit("update:modelValue", o.short_name);
        },
      },
    },
    data() {
        ...
        try {
          ...
          (this.showModal = !1),
            await window.ethereum.request({
              ...
              params: [{ chainId: `0x${e.chain_id.toString(16)}` }],
            });
        } catch (o) {
          o.code == 4902 &&
            (await window.ethereum.request({
  ...
  Vo = { class: "flex items-center gap-1.5" },
  Io = ["src", "alt"],
  Eo = { class: "uppercase relative top-0.5" },
  Uo = { class: "flex flex-col items-start w-full gap-3" },
  Do = ["onClick"],
  jo = ["src", "alt"],
  Ao = { class: "relative top-0.5 uppercase" };
      ...
      [
        t(
          "button",
          {
            ...
            class:
              "p-2.5 button-effect bg-lightGreen rounded-lg w-full flex items-center justify-between",
          },
          [
            t("div", Vo, [
              t(
              ...
              t(
                "span",
                Eo,
                s(a.selectedNetwork && a.selectedNetwork.short_name),
                1
              ),
            ]),
            i(d),
                        ...
                        (_, w) => (
                          ...
                          r(
                            "button",
                            {
                              key: w,
                              class: $([
                                "flex items-center gap-1.5 w-full button-effect p-2.5 rounded-lg",
                                {
                                  "bg-blue":
                                    _.short_name ==
                                    (a.selectedNetwork &&
                                      a.selectedNetwork.short_name),
                                },
                              ]),
                              onClick: (h) =>
                                (a.selectedNetwork = _.short_name),
                            },
                            [
                              t(
                                "img",
                                { src: _.logo, alt: _.short_name },
                                null,
                                8,
                                jo
                              ),
                              t("span", Ao, s(_.name), 1),
                            ],
                            10,
                            Do
                          )
  ...
  Zo = {
    ...
    watch: {
      modelValue(e) {
        ...
        o != e && this.updateInput({ target: { value: o } });
      },
    },
    computed: {
      ...v(["activeNetwork"]),
    ...
    methods: {
      checkValAndReset(e) {
        return typeof this.max < "u" &&
          new V(this.max).gte(0) &&
          new V(e).gt(this.max)
          ? this.max
          : e;
      },
      updateInput(e) {
        this.disabled ||
          (this.$emit(
            "update:modelValue",
            this.checkValAndReset(e.target.value)
          ),
          this.$emit("change"));
      },
      setToMax() {
        this.updateInput({ target: { value: this.max } });
      },
    },
  },
  Jo = { class: "flex flex-col items-start w-full gap-2.5" },
  Ko = { for: "amount", class: "relative top-0.5" },
  Qo = { class: "flex items-center gap-5 w-full" },
  Xo = {
    key: 0,
    class:
      "flex items-center justify-center h-16 bg-green button-effect rounded-lg px-5 gap-1.5",
  },
  es = ["src"],
  ts = { class: "uppercase relative top-0.5" },
  ns = {
    class:
      "bg-green h-16 px-5 button-effect rounded-lg w-full flex items-center justify-between gap-5",
  },
  os = ["value", "placeholder", "disabled"],
  ss = { key: 0, class: "flex flex-col items-end text-right w-44 text-sm" };
function ls(e, o, n, g, u, a) {
  return (
    l(),
    r("div", Jo, [
      t("label", Ko, s(n.label), 1),
      t("div", Qo, [
        n.disabled
          ? S("", !0)
          : (l(),
            r("div", Xo, [
              t("img", { src: e.activeNetwork.logo, alt: "" }, null, 8, es),
              t("span", ts, s(e.activeNetwork.short_name), 1),
            ])),
        t("div", ns, [
          t(
            "input",
            {
              ...
              type: "text",
              class: $([
                "w-full h-full bg-transparent outline-none placeholder-black",
              ...
              disabled: n.disabled,
              onInput:
                o[0] || (o[0] = (...d) => a.updateInput && a.updateInput(...d)),
            },
            null,
            42,
            os
            ...
            : (l(),
              r("div", ss, [
                t(
                  ...
                  {
                    onClick:
                      o[1] || (o[1] = (...d) => a.setToMax && a.setToMax(...d)),
                  },
                  "max"
                ),
                t("span", null, "Balance: " + s(a.balanceFormatted), 1),
              ])),
        ]),
      ]),
    ])
...
const as = f(Zo, [["render", ls]]),
  is = {
    ...
    data() {
      return { selectedNetwork: "", amountToSend: 0 };
    },
    watch: {
    ...
    computed: {
      ...
      selectableNetworks() {
        return this.networks.filter(
          (e) => e.short_name !== this.activeNetwork.short_name
        );
      },
    },
    methods: {
  ...
  rs = { id: "bridge", class: "dots bg-lightYellow relative" },
  cs = {
    class:
      "flex flex-col lg:flex-row justify-between items-center bg-yellow px-5 py-3 border-4 border-black text-xl",
  },
  ds = { class: "canaro-black" },
  us = {
    class:
      "bg-white border-4 border-t-0 border-black flex flex-col items-start w-full",
  },
  ms = { class: "py-9 px-8 lg:px-10 w-full flex flex-col items-start gap-9" },
  hs = {
    class:
      "flex flex-col items-start w-full p-5 bg-lightPink rounded-lg border-2 border-black gap-5",
  },
  fs = { class: "flex lg:flex-row flex-col lg:items-center gap-5 w-full" },
  _s = t(
    "h1",
    { class: "relative top-0.5 w-64" },
    "Select Network to Bridge",
    -1
  ),
  gs = { class: "flex lg:flex-row flex-col items-center gap-5 w-full" },
  ps = {
    class:
      "flex flex-col items-start w-full p-5 bg-lighterBlue rounded-lg border-2 border-black gap-10",
  },
  bs = { class: "w-full relative" },
  ws = t("div", { class: "h-0.5 bg-black w-full" }, null, -1),
  ys = t(
    "div",
    ...
    [
      t(
        ...
        {
          class:
            "border-blue border-2 p-4 flex flex-col box-effect-gray text-2xl",
        },
        [
          t("span", null, "You are bridging"),
          t(
            "b",
      ...
      t(
        ...
        {
          class:
            "border-orange border-2 p-4 flex flex-col box-effect-gray text-2xl",
        },
        [
          t("span", null, "You are receiving"),
          t(
            "b",
            { class: "canaro-semibold text-5xl leading-none" },
            " 10,000 $Mullet "
      ...
      t(
        ...
        {
          class:
            "border-green border-2 p-4 flex flex-col box-effect-gray text-2xl",
        },
        [
          t("span", null, "Bridge Fee"),
          t(
            "b",
            { class: "canaro-semibold text-5xl leading-none" },
            " 0.0001 ETH "
          ),
          t("small", null, "\u2248 $0.377895"),
        ]
      ),
    ],
    -1
  ...
  ks = {
    class:
      "bg-black py-9 px-8 lg:px-10 w-full flex lg:flex-row flex-col lg:gap-0 gap-5 items-center justify-between",
  },
  vs = t(
    "div",
    { class: "text-white flex items-center gap-2.5" },
    [
      t("span", null, "Bridge Tokens:"),
      t(
        "span",
              ...
              t("div", us, [
                t("div", ms, [
                      ...
                      t("div", gs, [
                        i(
                          m,
                          {
                            ...
                            "onUpdate:modelValue":
                              o[0] ||
                              (o[0] = (p) => (e.activeNetwork.short_name = p)),
                            options: e.networks,
                            "is-change-network": "",
                          },
                          null,
                  ...
                  t("div", ps, [
                    ...
                    t("div", bs, [
                      ws,
                      i(_, { class: "absolute inset-0 w-full -top-5" }),
                    ]),
                    i(w, {
...
const xs = f(is, [["render", Cs]]),
  ...
  Ss = { class: "w-full flex flex-col items-start gap-5 text-xl canaro-bold" },
  Ls = { class: "flex space-x-4" },
  Ms = {
  ...
  Ts = {
    class:
      "bg-black bg-opacity-30 pt-24 pb-6 px-6 canaro-book text-white -mt-10 rounded-bl-2xl rounded-br-2xl h-full",
  };
  ...
  return (
    ...
    r("div", Ss, [
      t(
        ...
        {
          class: $([
            "box-effect flex flex-col items-center lg:items-start justify-center w-full relative z-1 p-4",
            n.color,
          ]),
        },
        [
          t("div", Ls, [
            t("h3", Ms, s(n.number), 1),
            t("h2", Bs, s(n.name), 1),
          ]),
          t(
            "img",
      ...
      t("span", Ts, s(n.description), 1),
    ])
  );
}
const G = f($s, [["render", Fs]]),
  Rs = {
    components: { Section: I, MechanicBlock: G, Button: N, BgEffect: P },
    computed: { ...v(["nativeCurrencySymbol", "tokenSymbol"]) },
  },
  Vs = { id: "mechanics", class: "bg-blue relative" },
  Is = t("br", null, null, -1),
  Es = { class: "flex flex-col lg:flex-row gap-14 w-full" };
function Us(e, o, n, g, u, a) {
  ...
  return (
    l(),
    r("div", Vs, [
      i(d, { class: "opacity-15 lg:opacity-100" }),
      i(
        _,
        { title: "game theory mechanics" },
        {
          subtitle: x(() => [
            y(
              " Unlike vanilla memes, " +
                s(e.tokenSymbol) +
                " offers a unique game theory approach to " +
                s(e.nativeCurrencySymbol) +
                " reflections. ",
              1
            ),
            Is,
            y(" Here is how it works: "),
          ]),
          default: x(() => [
            t("div", Es, [
              i(
...
const Ds = f(Rs, [["render", Us]]),
  js = "/graphics/triangle-large.png",
  As = {
    components: { Section: I, MechanicBlock: G, Button: N, BgEffect: P },
    computed: {
      ...v(["links", "nativeCurrencySymbol", "tokenName", "tokenSymbol"]),
    },
  },
  Hs = { id: "vision", class: "dots relative mt-16 md:mt-28 lg:mt-0" },
  zs = t(
    "img",
    { class: "absolute -top-10 right-0 z-1", src: js, alt: "" },
    null,
    -1
  ),
  Os = { class: "flex items-center justify-end relative" },
  Ps = {
    class:
      "bg-white border-4 border-black h-full box-effect w-full lg:w-4/5 mt-2 gap-8 flex flex-col py-9 lg:py-16 px-8 lg:px-48",
  },
  Ws = { class: "relative vision-robot" },
  Ys = t("br", null, null, -1),
  qs = t("br", null, null, -1),
  Gs = { class: "text-center mt-4" },
  Zs = ["href"];
              ...
              t("div", Ps, [
                t("span", Ws, [
                  y(
                    " Embracing the " +
                      s(e.tokenSymbol) +
                      " spirit means being unapologetically ourselves. Ripping through a carton of cigs a day? Do it. Giving your wife dutch ovens on the reg because it's funny? Nice. Want to eat pancakes for dinner? Get after it. We capitalize on our unique strengths and stay resilient in the face of adversity. We thrive on defying convention and embracing the power of individuality. " +
                      s(e.tokenName) +
                      " is more than a brand, it's a movement celebrating self-expression and the joy of standing out. ",
                    1
                  ),
                  Ys,
                  qs,
                  y(
                    " On top of the core vision to spread " +
                      s(e.tokenSymbol) +
                      " vibes everywhere, we also showcase new unique game theory mechanics to reward the most diamond handed mulleteers with " +
                      s(e.nativeCurrencySymbol) +
                      " who are committed to building a strong community of bold, creative individuals. ",
                    1
                  ),
                  t("ul", Gs, [
                    t("li", null, s(e.tokenSymbol) + " is a mindset", 1),
                    t("li", null, s(e.tokenSymbol) + " is a state of being", 1),
                    t("li", null, s(e.tokenSymbol) + " is a zeitgeist", 1),
                    t("li", null, s(e.tokenSymbol) + " is culture", 1),
                  ]),
                ]),
                t(
                  "a",
...
const Ks = f(As, [["render", Js]]),
  ...
  nl = { id: "community", class: "relative bg-lightYellow bg-movement" },
  ol = t(
    "img",
    { src: Qs, class: "w-24 h-2w-24 relative z-1 mb-5", alt: "" },
    null,
    -1
  ),
  sl = {
    class:
      "flex flex-col lg:flex-row items-center justify-end relative lg:-mt-56",
  },
  ll = t("img", { src: Xs, alt: "" }, null, -1),
  al = {
    class:
      "flex bg-white border-4 border-black h-full box-effect w-full mt-2 gap-8 py-16 px-16 relative z-0",
  },
  il = { class: "relative text-center" },
  rl = t("br", null, null, -1),
  cl = t("br", null, null, -1),
  dl = ["href"],
  ul = t("img", { src: el, alt: "" }, null, -1);
          ...
          default: x(() => [
            t("div", sl, [
              ...
              t("div", al, [
                t("span", il, [
                  y(
                    " Our community honors the mullet\u2019s cultural legacy while pushing boundaries to keep it fresh and relevant. We're a collective of individuals driven by the thrill of innovation, the buzz of the days first dart, big clapping cheeks, and the confidence to take the risks necessary to reap rewards. Cool under pressure, we navigate life\u2019s highs and lows with unwavering confidence and adaptability. "
                  ),
                  rl,
                  cl,
                  y(
                    " Join the " +
                      s(e.tokenSymbol) +
                      " movement and turn bold self-expression into tangible success. ",
                    1
                  ),
                  t(
                    "a",
                    ...
                    [
                      i(d, {
                        ...
                        size: "large",
                        class:
                          "bg-yellow canaro-black absolute -bottom-7 left-0 right-0 mx-auto xl:w-3/4",
...
const hl = f(tl, [["render", ml]]),
  fl = "/graphics/tokenomics.png",
  _l = {
    components: { Section: I, BoardBlock: de, Contract: re, Button: N },
    computed: {
      ...v(["activeNetwork", "buyOnDexUrl", "tokenSymbol", "links"]),
      ...D({ mulletData: ({ main: e }) => e.mulletData }),
      activeChain() {
        return (
          (this.activeNetwork && this.activeNetwork.short_name.toUpperCase()) ||
          "BASE"
        );
      },
      totalSupplyFormatted() {
        return (
          (this.mulletData &&
            ne(
              new V(this.mulletData.totalSupply).div(
                new V(10).pow(this.mulletData.decimals)
              )
            )) ||
          0
        );
  ...
  gl = { id: "tokenomics", class: "bg-lightyellow" },
  pl = {
    class:
      "flex flex-col lg:flex-row-reverse items-center justify-center gap-10 mt-0",
  },
  bl = t("img", { src: fl, class: "object-contain", alt: "" }, null, -1),
  wl = { class: "grid grid-cols-1 lg:grid-cols-2 gap-5 w-full" },
  yl = ["href"];
...
const vl = f(_l, [["render", kl]]),
  Cl = "/graphics/footer-right.png",
  xl = {
    computed: {
      ...v(["isConnected", "links", "tokenSymbol"]),
      linksAry() {
        return [
          { name: "Audit", url: this.links.audit, external: !0 },
          { name: "Whitepaper", url: this.links.whitepaper, external: !0 },
          { name: "Explorer", url: this.links.explorer, external: !0 },
          { name: "Twitter", url: this.links.twitter, external: !0 },
          { name: "Telegram", url: this.links.telegram, external: !0 },
          { name: "Contact Us", url: this.links.contact, external: !0 },
        ];
      },
    },
    methods: {
  ...
  $l = { class: "h-50 w-full flex items-center justify-center bg-blue mt-20" },
  Sl = {
    class:
      "flex flex-col md:flex-row gap-10 justify-between w-full max-w-section items-center px-0 md:px-10 pt-10 md:pt-0",
  },
  Ll = {
    class: "grid md:grid-cols-2 gap-x-10 md:border-r pr-10 mb-10 md:mb-0",
  },
  Ml = ["href"],
  Bl = t("img", { src: Cl, class: "h-60 -mt-10", alt: "" }, null, -1);
      ...
      t("div", Sl, [
        t("img", {
          onClick:
            o[0] ||
            (o[0] = (...m) =>
              a.checkAndDepositRewards && a.checkAndDepositRewards(...m)),
          src: ce,
          class: "h-40",
          alt: "",
        }),
...
const Ul = f(Fl, [["render", El]]),
  Dl = {
    name: "NetworkSwitch",
    components: { IconSwitch: Ul },
    computed: {
      ...v(["isConnected"]),
      ...D({ networks: ({ main: e }) => e.networks }),
    },
    methods: {
      async switchNetwork(e) {
        ...
        try {
          ...
          await window.ethereum.request({
            method: "wallet_switchEthereumChain",
            params: [{ chainId: `0x${o.chain_id.toString(16)}` }],
          });
        } catch (n) {
          n.code == 4902 &&
            (await window.ethereum.request({
  ...
  jl = {
    class:
      "flex items-center justify-between w-full border-4 border-black p-5 bg-darkPink box-effect fixed z-10 bottom-24 sm:right-8 right-0 sm:max-w-md max-w-none gap-5",
  },
  Al = t(
    "span",
    { class: "text-white" },
    " The network is invalid. Please switch to the BASE network. ",
    -1
  );
  ...
  return (
    ...
    r(
      ...
      [
        ...
        i(p),
        i(T),
        !e.isOnValidNetwork && e.isConnected
          ? (l(), C(j, { key: 0 }))
          : S("", !0),
      ],
      64
